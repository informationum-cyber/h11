    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <header className="w-full max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center border-b border-gray-100">
        ...
        <nav className="flex gap-6 text-sm font-medium text-gray-600">
          ...
          <Link to="/vizhun" className="text-[#1E5C3A] font-semibold">Vizhun</Link>
        </nav>
      </header>
      ...
      <main className="w-full max-w-6xl mx-auto px-6 py-16">
        <div className="mb-16 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#143D2D] mb-6">Vizhun</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
            <div className="w-12 h-12 bg-[#1E5C3A]/10 rounded-lg flex items-center justify-center mb-6">
              <Sparkles className="w-6 h-6 text-[#1E5C3A]" />
            </div>
            <h2 className="text-xl font-bold text-[#143D2D] mb-3">Speak Your Vision</h2>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
            <div className="w-12 h-12 bg-[#143D2D]/10 rounded-lg flex items-center justify-center mb-6">
              <ListChecks className="w-6 h-6 text-[#143D2D]" />
            </div>
            <h2 className="text-xl font-bold text-[#143D2D] mb-3">Get a Real Plan</h2>
            <p className="text-gray-600 flex-grow">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
            <div className="w-12 h-12 bg-[#1E5C3A]/10 rounded-lg flex items-center justify-center mb-6">
              <Clock3 className="w-6 h-6 text-[#1E5C3A]" />
            </div>
            <h2 className="text-xl font-bold text-[#143D2D] mb-3">Fits Your Calendar</h2>
            <p className="text-gray-600 flex-grow">
        ...
        <div className="bg-[#143D2D] rounded-2xl p-10 text-center max-w-4xl mx-auto flex flex-col items-center">
          <CalendarClock className="w-12 h-12 text-[#1E5C3A] mb-4" />
          ...
          <a href="mailto:vizhun@hanseleleven.com?subject=Vizhun%20Waitlist" className="bg-[#1E5C3A] hover:bg-[#144D2E] text-white px-8 py-4 rounded-sm text-lg font-medium transition-all shadow-lg hover:shadow-xl inline-flex items-center">
