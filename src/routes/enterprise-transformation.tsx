    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <header className="w-full max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center border-b border-gray-100">
        ...
        <nav className="flex gap-6 text-sm font-medium text-gray-600">
          <Link to="/enterprise-transformation" className="text-[#1E5C3A] font-semibold">Enterprise</Link>
      ...
      <main className="w-full max-w-6xl mx-auto px-6 py-16">
        <div className="mb-16 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#143D2D] mb-6">Enterprise Transformation</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
            <div className="w-12 h-12 bg-[#143D2D]/10 rounded-lg flex items-center justify-center mb-6">
              <Settings className="w-6 h-6 text-[#143D2D]" />
            </div>
            <h2 className="text-2xl font-bold text-[#143D2D] mb-3">HART Framework</h2>
            <p className="text-sm text-[#1E5C3A] font-semibold tracking-wide uppercase mb-4">Flagship Offering</p>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
            <div className="w-12 h-12 bg-[#143D2D]/10 rounded-lg flex items-center justify-center mb-6">
              <ShieldCheck className="w-6 h-6 text-[#143D2D]" />
            </div>
            <h2 className="text-2xl font-bold text-[#143D2D] mb-3">Delivery Consulting</h2>
            <p className="text-sm text-[#1E5C3A] font-semibold tracking-wide uppercase mb-4">Implementation Support</p>
            <p className="text-gray-600 flex-grow">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
            <div className="w-12 h-12 bg-[#143D2D]/10 rounded-lg flex items-center justify-center mb-6">
              <Users2 className="w-6 h-6 text-[#143D2D]" />
            </div>
            <h2 className="text-2xl font-bold text-[#143D2D] mb-3">PMO Workshops</h2>
            <p className="text-sm text-[#1E5C3A] font-semibold tracking-wide uppercase mb-4">Training + Change Management</p>
            <p className="text-gray-600 flex-grow">
        ...
        {/* CTA */}
        <div className="bg-[#1E5C3A] rounded-2xl p-10 text-center max-w-4xl mx-auto flex flex-col items-center">
          ...
          <a href="mailto:enterprise@hanseleleven.com" className="bg-white text-[#1E5C3A] px-8 py-4 rounded-sm text-lg font-bold transition-all shadow-lg hover:shadow-xl inline-flex items-center">
