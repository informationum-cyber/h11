    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <header className="w-full max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center border-b border-gray-100">
        ...
        <nav className="flex gap-6 text-sm font-medium text-gray-600">
          ...
          <Link to="/career-transformation" className="text-[#DD6547] font-semibold">Career</Link>
      ...
      <main className="w-full max-w-6xl mx-auto px-6 py-16">
        <div className="mb-16 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#232C33] mb-6">Career Transformation</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
            ...
            <h2 className="text-2xl font-bold text-[#232C33] mb-3">CECY Program</h2>
            <p className="text-sm text-[#DD6547] font-semibold tracking-wide uppercase mb-4">Mentorship</p>
            ...
            <div className="bg-gray-50 p-6 rounded-xl text-center">
              <p className="text-lg font-bold text-[#232C33] mb-4">Free Consult</p>
              <a href="mailto:cecy@hanseleleven.com" className="inline-block w-full px-4 py-3 bg-[#232C33] text-white rounded-sm font-medium hover:bg-[#1A2126] transition-colors">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
            <div className="w-12 h-12 bg-[#DD6547]/10 rounded-lg flex items-center justify-center mb-6">
              <Compass className="w-6 h-6 text-[#DD6547]" />
            </div>
            <h2 className="text-2xl font-bold text-[#232C33] mb-3">Early Career Coaching</h2>
            <p className="text-sm text-[#DD6547] font-semibold tracking-wide uppercase mb-4">1:1 Coaching</p>
            <p className="text-gray-600 mb-6 flex-grow">
            ...
            <div className="bg-gray-50 p-6 rounded-xl flex flex-col gap-3">
              <div className="flex justify-between items-center bg-white p-3 rounded shadow-sm border border-gray-100">
                ...
                <span className="text-lg font-bold text-[#232C33]">$70</span>
              </div>
              <div className="flex justify-between items-center bg-white p-3 rounded shadow-sm border border-gray-100">
                <span className="text-gray-600 font-medium">1.5 hours</span>
                <span className="text-lg font-bold text-[#232C33]">$120</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
            <div className="w-12 h-12 bg-[#DD6547]/10 rounded-lg flex items-center justify-center mb-6">
              <Briefcase className="w-6 h-6 text-[#DD6547]" />
            </div>
            <h2 className="text-2xl font-bold text-[#232C33] mb-3">Career Transitions</h2>
            <p className="text-sm text-[#DD6547] font-semibold tracking-wide uppercase mb-4">Interview Coaching</p>
            <p className="text-gray-600 mb-6 flex-grow">
            ...
            <div className="bg-gray-50 p-6 rounded-xl flex flex-col gap-3">
              <div className="flex justify-between items-center bg-white p-3 rounded shadow-sm border border-gray-100">
                ...
                <span className="text-lg font-bold text-[#232C33]">$230</span>
              </div>
              <div className="flex justify-between items-center bg-white p-3 rounded shadow-sm border border-gray-100">
                <span className="text-gray-600 font-medium">4 hours</span>
                <span className="text-lg font-bold text-[#232C33]">$315</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#232C33] rounded-2xl p-10 text-center max-w-4xl mx-auto flex flex-col items-center">
          ...
          <a href="mailto:coaching@hanseleleven.com" className="bg-[#DD6547] hover:bg-[#C2553A] text-white px-8 py-4 rounded-sm text-lg font-medium transition-all shadow-lg hover:shadow-xl inline-flex items-center">
