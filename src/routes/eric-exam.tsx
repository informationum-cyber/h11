...
import { Lock, ArrowRight, ListChecks, BookOpen } from 'lucide-react'
...
type Mode = 'gate' | 'choose' | 'regular' | 'scenario'
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 font-light">
                      The full timed practice exam — 50 questions, 100 minutes, all three PMP domains.
                    </p>
                  </div>
