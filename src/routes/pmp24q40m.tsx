...
import { pmp24q40mQuestions, type PMPDomain, type PMPQuestion } from '../data/pmp24q40m-questions'

export const Route = createFileRoute('/pmp24q40m')({
  component: PMP24Q40M,
})

const TEST_PASSWORD = 'PMP40'
const DURATION_SECONDS = 40 * 60
const UNLOCK_KEY = 'pmp24q40m_unlocked'
...
function PMP24Q40M() {
  ...
  function handleUnlock(e: React.FormEvent) {
    e.preventDefault()
    if (passwordInput.trim().toUpperCase() === TEST_PASSWORD) {
  ...
  const question = pmp24q40mQuestions[currentIndex]
  ...
  const results = useMemo(() => {
    ...
    let correctCount = 0
    for (const q of pmp24q40mQuestions) {
      ...
      <main className="w-full max-w-4xl mx-auto px-6 py-16">
        {stage === 'gate' && (
          <div className="max-w-md mx-auto text-center">
            ...
            <h1 className="text-3xl font-bold text-[#143D2D] mb-3">PMP24Q40M Practice Test</h1>
        ...
        {stage === 'intro' && (
          <div className="max-w-2xl mx-auto text-center">
            <h1 className="text-4xl font-bold text-[#143D2D] mb-4">PMP24Q40M Practice Test</h1>
            <p className="text-gray-600 mb-10 font-light text-lg">
              24 scenario-based questions covering all three PMP domains, timed to a 40-minute window.
            </p>
            <div className="grid grid-cols-3 gap-4 mb-10">
              <div className="bg-gray-50 rounded-xl p-5">
                <div className="text-3xl font-black text-[#143D2D]">24</div>
                <div className="text-xs text-gray-500 uppercase tracking-wide mt-1">Questions</div>
              </div>
              <div className="bg-gray-50 rounded-xl p-5">
                <div className="text-3xl font-black text-[#143D2D]">40</div>
          ...
          <div>
            <div className="flex items-center justify-between mb-6 sticky top-0 bg-white/95 backdrop-blur py-3 z-10">
              <span className="text-sm font-medium text-gray-500">
                Question {currentIndex + 1} of {pmp24q40mQuestions.length} &middot; {answeredCount} answered
              </span>
              <span
            ...
            <div className="flex items-center justify-between">
              ...
              {currentIndex < pmp24q40mQuestions.length - 1 ? (
                <button
                  onClick={() => setCurrentIndex((i) => Math.min(pmp24q40mQuestions.length - 1, i + 1))}
        ...
        {stage === 'results' && (
          <ResultsAdvisory
            results={results}
            totalQuestions={pmp24q40mQuestions.length}
            onRetake={retakeTest}
          />
        )}
      </main>
...
function ResultsAdvisory({
  ...
  return (
    <div>
      ...
      <h1 className="text-3xl font-bold text-[#143D2D] mb-2">Your PMP24Q40M Results</h1>
      ...
      <div className="mb-10">
        ...
        <div className="space-y-4">
          {(() => {
            ...
            return pmp24q40mQuestions.map((q) => {
